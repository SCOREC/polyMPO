...
void polympo_startRebuildingMPs_f(MPMesh_ptr p_mpmesh, const int numMPs, const int* allMP2Elm, const int* addedMPMask);
void polympo_finishRebuildingMPs_f(MPMesh_ptr p_mpmesh);
void polympo_startMigratingMPs_f(MPMesh_ptr p_mpmesh, const int numMPs, const int* allMP2Elm, const int* allMP2Process, const int* addedMPMask);
